...
highchart_server  <- function(input1 = character(), input_choices1 = character(), input2 = NULL, input_choices2 = NULL, df_set1 = character(), df_set2 = NULL, df_set3 = NULL, title = character(),...) {
  # index1 <- match(input1, input_choices1)
  # if (!is.null(input2)) {
  # index2 <- match(input2, input_choices2)
  # }
  # 
  # df <- list(df_set1, df_set2, df_set3)
  # df <- df[index1, index2]
